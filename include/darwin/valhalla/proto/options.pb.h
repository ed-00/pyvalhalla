...
constexpr Options_Format Options_Format_Format_MAX = static_cast<Options_Format>(3);
constexpr int Options_Format_Format_ARRAYSIZE = 3 + 1;
...
constexpr Options_ExpansionProperties Options_ExpansionProperties_ExpansionProperties_MAX = static_cast<Options_ExpansionProperties>(4);
constexpr int Options_ExpansionProperties_ExpansionProperties_ARRAYSIZE = 4 + 1;
...
constexpr ShapeFormat ShapeFormat_MAX = static_cast<ShapeFormat>(2);
constexpr int ShapeFormat_ARRAYSIZE = 2 + 1;
...
class PbfFieldSelector final : public ::google::protobuf::MessageLite
...
class Contour final : public ::google::protobuf::MessageLite
...
class AvoidEdge final : public ::google::protobuf::MessageLite
...
class Ring final : public ::google::protobuf::MessageLite
...
class Costing_Options final : public ::google::protobuf::MessageLite
...
class Costing final : public ::google::protobuf::MessageLite
...
class Options final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:valhalla.Options) */ {
 ...
 public:
  ...
  static constexpr ExpansionProperties costs = Options_ExpansionProperties_costs;
  static constexpr ExpansionProperties durations = Options_ExpansionProperties_durations;
  static constexpr ExpansionProperties distances = Options_ExpansionProperties_distances;
  static constexpr ExpansionProperties statuses = Options_ExpansionProperties_statuses;
  static constexpr ExpansionProperties edge_ids = Options_ExpansionProperties_edge_ids;
